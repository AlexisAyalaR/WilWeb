...
<header class="header w3-white">
	<nav class="w3-bar w3-border w3-blue w3-top">
		...
		<li class="w3-bar-item w3-button w3-mobile w3-border-right"><a class="link" href="#article"><i class="fa fa-code" aria-hidden="true"></i> Proyectos</a></li>
		<li class="w3-bar-item w3-button w3-mobile w3-border-right"><a class="link" href="#section5"><i class="fa fa-terminal" aria-hidden="true"></i> ???</a></li>
